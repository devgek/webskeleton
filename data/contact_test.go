...
func TestCreateContact(t *testing.T) {
	...
	customer := &models.Contact{OrgType: types.OrgTypeOrg, Name: "Mustermann GesmbH", CustomerType: types.CustomerTypeC, ContactAddresses: []models.ContactAddress{*contactAddress}}
