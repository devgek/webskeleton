...
function GKEntityTable(entity, entityEmbedded) {
  ...
  this.urlEdit = "entityedit" + this.entity;
  this.urlNew = "entitynew" + this.entity;
  this.urlDelete = "entitydelete" + this.entity;
  this.editRowData = [];
  ...
  this.sendRowData = function (sendParams) {
    ...
    var posting = $.post(this.getEditUrl(), postData);
    ...
    posting.done(function (data) {
      ...
      if (isError) {
        ...
        var rowData = activeGKEntityTable.getRowDataFromEntity(data);
